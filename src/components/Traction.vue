<template>
  <section class="text-white py-12 md:py-16 lg:pt-20 px-4 sm:px-6 lg:px-12">
    <div class="max-w-7xl mx-auto">
      <!-- Main Content Grid -->
      <div
        class="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center"
      >
        <!-- Image Section -->
        <div class="order-2 lg:order-1 w-full">
          <img
            src="/public/image 18.png"
            alt="Traction visuelle"
            class="w-full h-auto"
          />
        </div>
        ...
        <div class="order-1 lg:order-2 space-y-6 md:space-y-8">
          <h2
            class="text-3xl sm:text-4xl md:text-xl lg:text-5xl font-bold leading-tight"
          >
            Traction & Confiance
          </h2>
          ...
          <div class="space-y-4 md:space-y-6">
            ...
            >
              ...
              <!-- Text -->
              <p
                class="text-base sm:text-lg md:text-xl lg:text-2xl font-medium"
              >
          ...
          <div class="flex flex-col sm:flex-row items-start gap-4 pt-4">
            <StoreButtons
              class="flex flex-col sm:flex-row gap-3 sm:gap-4 items-center"
            />
          </div>
        </div>
      </div>
