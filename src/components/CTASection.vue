...
<template>
  <section
    class="relative bg-black text-white px-4 sm:px-6 md:px-12 lg:px-24 overflow-hidden"
  >
    ...
    <div class="relative max-w-7xl mx-auto">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
        <div class="text-center lg:text-left">
          <h2
            class="text-3xl sm:text-4xl md:text-xl lg:text-5xl font-bold mb-4 md:mb-6 leading-tight"
          >
          ...
          >
            <StoreButtons
              class="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-6"
            />
            <div>
              <button
